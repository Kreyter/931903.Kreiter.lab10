...
function curtain()
{
	...
	document.querySelector(".lampBox").onmousedown = function()
	{
		document.getElementById("lamp_rope").style.top = 45+'px';
	}
	document.querySelector(".lampBox").onmouseup = function()
	{
		document.getElementById("lamp_rope").style.top = 25+'px';
	}
}
...
function rabbit_pigeon()
{
	if (h === 0)
	{
		...
		setTimeout ('pigeon.style.top = -90+ "px"',1000);	
